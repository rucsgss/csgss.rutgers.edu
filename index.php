    ...
    <div class="container">
      ...
      <div class="page_content">
        ...
        <div class="news">
          ...
          <div class="newsitem">
            <div>
              <h2>Fall 2015 Calendar</h2>
              <h3>Tue., Sept. 8, 2015</h3>
              <h4>Lunch socials</h4>
              <p>11 am - 12 pm in Core 301</p>
              <p>9/24, 10/29, and 12/3</p>
              <h4>Coffee hours</h4>
              <p>3 - 4 pm in Core 301</p>
              <p>9/10, 9/25, 10/2, 10/9, 10/16, 10/23, 10/30, 11/6, 11/20, and 12/4</p>
            </div>
            <div class="clear"></div>
          </div>
